...
def calculate(params: Dict[str, Any]) -> Dict[str, Any]:
    ...
    参数:
        ...
        shareholderTransferRatios: [{shareholderId, transferRatio}]
    """
    ...
    ratios = params["shareholderTransferRatios"]
    ...
    ratio_map = {item["shareholderId"]: item["transferRatio"] for item in ratios}

    transfer_details = []
    after_transfer = []
    for sh in shareholders:
        ratio = ratio_map.get(sh["id"], 0)
        transferred = sh["capital"] * ratio
